...
function AddFieldScreen({navigation, route}, props) {
...
const height = windowWidth*0.7
  ...
  _handleNextClick =()=>{
    navigation.navigate(Routes.MapFieldScreen)
  }
  return (
    <View style={styles.container}>
      <StatusBar barStyle='dark-content' backgroundColor={Platform.OS === 'ios' ? colors.white : colors.lightGray1} />
        ...
        <View style={styles.contentContainer}>
            ...
            <Text style={styles.headerTitle}>Enter New Field Details</Text>
            <View style={{backgroundColor:'#ffffff', paddingVertical:20, borderRadius:15, marginTop:30, overflow:'hidden', }}>
                ...
                <View style={{...styles.historyTitleContainer, backgroundColor:''}}>
                  <View>
                    <Text style={styles.historyTitle}>Field name ( Used to identify field )</Text>
                    <View style={{
                      width: 20,
                      height: 3,
              ...
              onSubmitEditing={() => _onLoadUser()}
              
            />
                  <View style={{...styles.historyTitleContainer, backgroundColor:''}}>
                  <View>
                    <Text style={styles.historyTitle}>Soil type</Text>
                    <View style={{
                      width: 20,
                      height: 3,
                      backgroundColor: '#52734D',
            ...
            />
                  <View style={{...styles.historyTitleContainer, backgroundColor:''}}>
                  <View>
                    <Text style={styles.historyTitle}>Crop grown (Winter)</Text>
                    <View style={{
                      width: 20,
                      height: 3,
                      backgroundColor: '#52734D',
            ...
            />
                 <View style={{...styles.historyTitleContainer, backgroundColor:''}}>
                  <View>
                    <Text style={styles.historyTitle}>Crop grown (Summer)</Text>
                    <View style={{
                      width: 20,
                      height: 3,
                      backgroundColor: '#52734D',
            ...
            />
                  <View style={{...styles.historyTitleContainer, backgroundColor:''}}>
                  <View>
                    <Text style={styles.historyTitle}>Field Description</Text>
                    <View style={{
                      width: 20,
                      height: 3,
                      backgroundColor: '#52734D',
              ...
              style={styles.textInput}
              inputContainerStyle={styles.inputContainer}
              containerStyle={{...styles.textInputContainer, height:250, marginBottom:70}}
              keyboardType='default'
              returnKeyType={'done'}
              multiline
              cursorColor={'#52734D'}
            ...
            <TouchableOpacity style={{position:'absolute', bottom:0, height:60, backgroundColor:'#52734D', width:'100%', alignItems:'center', justifyContent:'center'}} onPress={()=>{_handleNextClick()}}>
                <Text style={{color:'white', fontFamily:'montserrat-medium', fontSize:22, textAlign:'center'}}>Continue</Text>
            </TouchableOpacity>
            </View>
...
export default connectAlert(AddFieldScreen);
