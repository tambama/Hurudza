    ...
    return (
      ...
      >
        <View>
            ...
            {
              requests !== undefined && requests.map(request => (
                <ListItem
                key={wallet.walletCode}
                style={styles.walletItem}
                onPress={() => this._goToDetail(wallet)}>
                  <ListItem.Content>
                    <View style={styles.walletItemContent}>
                      <View style={styles.walletItemContentLeft}>
                        <Icon
                          type={'simple-line-icon'}
                          name='wallet' 
                          size={36}
                          color={colors.iconsGrey} />
                        <View style={styles.walletItemContentMiddle}>
                          <View style={styles.walletItemTitleContainer}>
                            <Text style={styles.walletItemTitlePrefix}></Text>
                            <Text style={styles.walletItemTitle}>{wallet.walletName}</Text>
                          </View>
                          <Text style={styles.walletItemSubtitle}>{wallet.signedAmount}</Text>
                        </View>
                      </View>
                      <View style={styles.walletItemRightText}>
                        <Icon
                          name='chevron-right'
                          type='evilicon'
                          size={26} 
