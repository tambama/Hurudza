    ...
    <View style={styles.container}>
      <StatusBar barStyle='dark-content' backgroundColor={Platform.OS === 'ios' ? colors.white : colors.white} />
        ...
        <View style={{...styles.historyTitleContainer, backgroundColor:'transparent'}}>
            ...
            <View style={{...styles.history, width:'100%', flex:1, borderColor:'rgba(0,0,0,0.3)', borderWidth:1}}>
                ...
                <TouchableOpacity style={{position:'absolute', bottom:0, height:50, backgroundColor:'#52734D', width:'100%', alignItems:'center', justifyContent:'center', flexDirection:'row'}} onPress={()=>{navigation.navigate(Routes.AddInventory)}}>
